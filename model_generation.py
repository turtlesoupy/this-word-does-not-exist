...
lm_head_model = GPT2LMHeadModel.from_pretrained(args.model)
...
builder = neural_network.NeuralNetworkBuilder(
    input_features, output_features, mode=None, disable_rank5_shape_mapping=True,
)
